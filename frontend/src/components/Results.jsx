          ...
          <div className="space-y-4">
            {data.vulnerabilities
              ...
              >
                ...
                {vuln.masked_value && (
                  <div className="bg-red-500/10 border border-red-500/30 rounded-lg p-4 mb-4 overflow-hidden">
                    <div className="flex items-start gap-2 min-w-0">
                      <span className="text-red-400 font-bold shrink-0">🔐 Detected:</span>
                      <code className="text-red-300 font-mono text-sm break-all overflow-wrap-anywhere">{vuln.masked_value}</code>
                    </div>
                  </div>
                )}

                {vuln.code && !vuln.masked_value && (
                  <div className="bg-gray-900 rounded-lg p-4 mb-4 overflow-x-auto max-w-full">
                    <code className="text-red-400 text-sm font-mono whitespace-pre-wrap break-all">
                      {vuln.code}
                    </code>
                  </div>
                )}
